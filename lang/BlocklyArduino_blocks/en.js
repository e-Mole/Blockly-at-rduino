...
Blockly.Msg.MG_ARDUINO_SERVO_MOVE_INPUT1 = "MG Servo: Rotate";
Blockly.Msg.MG_ARDUINO_SERVO_MOVE_INPUT2 = "port";
Blockly.Msg.MG_ARDUINO_SERVO_MOVE_DEGREE = "angle (0~180°)";
Blockly.Msg.MG_ARDUINO_SERVO_MOVE_TOOLTIP = "Rotation typical possible between 0 ~ 180 degrees, better input in microseconds 500 ~ 2500 us, typical 1500 us = 90° (center position)";
Blockly.Msg.MG_ARDUINO_SERVO_READ_DEGREES_HELPURL = "http://www.arduino.cc/playground/ComponentLib/servo";
Blockly.Msg.MG_ARDUINO_SERVO_READ_DEGREES_INPUT1 = "MG Servo: angle";
Blockly.Msg.MG_ARDUINO_SERVO_READ_DEGREES_INPUT2 = "port";
Blockly.Msg.MG_ARDUINO_SERVO_READ_DEGREES_TOOLTIP = "returns the number of degrees, or microseconds for the last rotation settings";
Blockly.Msg.MG_ARDUINO_SERVO_ATTACH1 = "MG Servo: Attach";
Blockly.Msg.MG_ARDUINO_SERVO_ATTACH2 = "Assign Name";
Blockly.Msg.MG_ARDUINO_SERVO_DETACH = "MG Servo: Detach";
...
Blockly.Msg.MG_ARDUINO_U01_COM_TOOLTIP = "Block for sending sensor data to MoleGraph App. This version is for MoleGraph U01 unit based on Arduino NANO, or standalone Arduino NANO/UNO. For more info visit MoleGraph webpage www.e-mole.cz/diy/molegraph";
...
Blockly.Msg.MG_ARDUINO_U01_BATTERY_TOOLTIP = "Get MG U01 battery status: 0 - no battery, 1 - battery ok, 2 - battery low.";
Blockly.Msg.MG_ARDUINO_U01_BATTERY_BLOCK = "MG U01 battery status";
Blockly.Msg.MG_ARDUINO_U01_PULLUP_STATE_ON = "state on";
Blockly.Msg.MG_ARDUINO_U01_PULLUP_STATE_OFF = "state off";
Blockly.Msg.MG_ARDUINO_U01_BUTTON_F1 = "button F1";
Blockly.Msg.MG_ARDUINO_U01_BUTTON_F2 = "button F2";
Blockly.Msg.MG_ARDUINO_U01_BUTTON_F3 = "button F3";
Blockly.Msg.MG_ARDUINO_U01_BUTTON_F4 = "button F4";
Blockly.Msg.MG_ARDUINO_U01_BUTTON_PRESSED = "pressed";
Blockly.Msg.MG_ARDUINO_U01_PORT_D = "pin digital (GPIO 01)";
Blockly.Msg.MG_ARDUINO_U01_PORT_A = "pin analog (GPIO 02)";
Blockly.Msg.MG_ARDUINO_U01_UNIT_ON = "type U01 UNIT";
Blockly.Msg.MG_ARDUINO_U01_UNIT_OFF = "type NANO/UNO";
Blockly.Msg.MG_ARDUINO_U01_MEASURING_BLOCK = "MG measurement in progress";
Blockly.Msg.MG_ARDUINO_U01_MEASURING_TOOLTIP = "Return true/false if measurement is/is not in progress.";
Blockly.Msg.MG_ARDUINO_U01_MEASURING_START_TOOLTIP = "Start MoleGraph measurement on connected device.";
Blockly.Msg.MG_ARDUINO_U01_MEASURING_STOP_TOOLTIP = "Stop MoleGraph measurement on connected device.";